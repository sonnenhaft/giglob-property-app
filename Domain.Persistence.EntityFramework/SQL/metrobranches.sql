...
select @colorId = ID from [dbo].[MetroBranches] WHERE HexColor='ffff00' AND CityId =1
...
select @colorId = ID from [dbo].[MetroBranches] WHERE HexColor='6aa84f' AND CityId =1
INSERT INTO [dbo].[MetroStationToMetroBranchRelations]([StationId],[BranchId])VALUES (@stationId,@colorId)
select @stationId = ID from [dbo].[MetroStations] WHERE Name='Академическая' AND CityId =1
select @colorId = ID from [dbo].[MetroBranches] WHERE HexColor='ff9900' AND CityId =1
INSERT INTO [dbo].[MetroStationToMetroBranchRelations]([StationId],[BranchId])VALUES (@stationId,@colorId)
select @stationId = ID from [dbo].[MetroStations] WHERE Name='Александровский сад' AND CityId =1
select @colorId = ID from [dbo].[MetroBranches] WHERE HexColor='9fc5e8' AND CityId =1
INSERT INTO [dbo].[MetroStationToMetroBranchRelations]([StationId],[BranchId])VALUES (@stationId,@colorId)
...
select @colorId = ID from [dbo].[MetroBranches] WHERE HexColor='b7b7b7' AND CityId =1
INSERT INTO [dbo].[MetroStationToMetroBranchRelations]([StationId],[BranchId])VALUES (@stationId,@colorId)
...
select @colorId = ID from [dbo].[MetroBranches] WHERE HexColor='a64d79' AND CityId =1
INSERT INTO [dbo].[MetroStationToMetroBranchRelations]([StationId],[BranchId])VALUES (@stationId,@colorId)
select @stationId = ID from [dbo].[MetroStations] WHERE Name='Бауманская' AND CityId =1
select @colorId = ID from [dbo].[MetroBranches] WHERE HexColor='0000ff' AND CityId =1
INSERT INTO [dbo].[MetroStationToMetroBranchRelations]([StationId],[BranchId])VALUES (@stationId,@colorId)
...
select @colorId = ID from [dbo].[MetroBranches] WHERE HexColor='ff0000' AND CityId =1
INSERT INTO [dbo].[MetroStationToMetroBranchRelations]([StationId],[BranchId])VALUES (@stationId,@colorId)
...
select @colorId = ID from [dbo].[MetroBranches] WHERE HexColor='783f04' AND CityId =1
INSERT INTO [dbo].[MetroStationToMetroBranchRelations]([StationId],[BranchId])VALUES (@stationId,@colorId)
